(function($) {
	...
	if($('.main-header .navigation li.dropdown ul').length){
		$('.main-header .navigation li.dropdown').append('<div class="dropdown-btn"><Span class="icon iconfont icon-arrow-down"></span></div>');
	...
	if ($('.three-item-carousel').length) {
		$('.three-item-carousel').owlCarousel({
			...
			smartSpeed: 700,
			autoplay: 5000,
			navText: [ '<span class="icon iconfont icon-arrow-left"></span>', '<span class="icon iconfont icon-arrow"></span>' ],
			responsive:{
				0:{
					items:1
				},
